...
import { createSubscritpion } from '../controllers/subscription.controller.js';
...
subscriptionRouter.get('/user/:id', (req, res) => { res.send({ title: 'GET User subscriptions details' }) });
